...
public final class CropRegistry {
    ...
    public CropRegistry(String mappingsCSV, String entriesCSV) {
        ...
        try {
            ...
            EnvironmentLib.LOGGER.error(LOG_MARKER, "failed to initialize registry", e);
    ...
    private void readMappingsCSV(InputStreamReader isr) throws Exception {
        EnvironmentLib.LOGGER.info(LOG_MARKER, "initializing common id mappings...");
        ...
        EnvironmentLib.LOGGER.info(LOG_MARKER, commonIdToModIdMapping.toString());
    }

    private void readCropsCSV(InputStreamReader streamReader) throws Exception {
        EnvironmentLib.LOGGER.info(LOG_MARKER, "registering crop entries...");
        ...
        EnvironmentLib.LOGGER.info(LOG_MARKER, commonIdMapping.toString());
        EnvironmentLib.LOGGER.info(LOG_MARKER, commonIdToModIdMapping.toString());
    }
}
